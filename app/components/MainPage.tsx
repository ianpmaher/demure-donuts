...
const MainPage = ({ className }: { className?: string }) => {
  const images = [
    ...
    { url: "https://i.imgur.com/ehqYwDy.png", description: "Birthday Cake", name: "Birthday", Icon: CookieIcon, href: "/", cta: "View Birthday", classes: "col-span-2" },
    { url: "https://i.imgur.com/4cPsfTF.png", description: "Breakfast Special", name: "Breakfast", Icon: DoubleArrowUpIcon, href: "/", cta: "View Breakfast", classes: "col-span-1" },
  ];
      ...
      <BentoGrid>
        {images.map((image, index) => (
          <BentoCard
            ...
            background={<Image src={image.url} alt={image.description} width={300} height={300} className=" object-fill" />}
            Icon={image.Icon}
